...
public class EnterTimeTrackPage extends BasePage {
	...
	public void createTask(String optionName, String custName, String projectName, String taskName,
		...
		webActionUtil.waitForNumberOfElementsToBeMore(By.xpath("//div[@class='task']"), currentCount);
	}
	...
	public void deleteTask(String taskName) {
		...
		webActionUtil.jsClick(deleteIcon);
		webActionUtil.jsClick(deletePermanentlyButton);	
