...
import com.skillrary.actitime.generics.FUtil;
import com.skillrary.actitime.generics.IAutoConstants;
import com.skillrary.actitime.generics.WebActionUtil;
import com.skillrary.actitime.pom.HomePage;
import com.skillrary.actitime.pom.LoginPage;
...
public class BaseTest implements IAutoConstants  {
	...
	public void loginToApp(@Optional(DEFULT_USER)String username,
		...
		homePage = new LoginPage(driver, webActionUtil).login(username, password);
	}
